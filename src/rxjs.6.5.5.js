...
;(function (k, h) {
  ...
  function Pa(c, a, b) {
    ...
    return function () {
      ...
      var f = this,
        g,
        m = { context: f, subject: g, callbackFunc: c, scheduler: b }
      return new n(function (d) {
        if (b) return b.schedule(Pb, 0, { args: a, subscriber: d, params: m })
        if (!g) {
          g = new T()
          try {
            c.apply(
  ...
  function Rb(c) {
    ...
    if (!m) {
      ...
      try {
          ...
          f.concat([
            function () {
              for (var b = [], c = 0; c < arguments.length; c++)
                b[c] = arguments[c]
              ;(c = b.shift())
                ? a.add(g.schedule(Ra, 0, { err: c, subject: m }))
                : a.add(
                    g.schedule(Sb, 0, {
                      value: 1 >= b.length ? b[0] : b,
                      subject: m,
        ...
        this.add(g.schedule(Ra, 0, { err: u, subject: m }))
      }
    }
    this.add(m.subscribe(d))
  }
  ...
  function Xa(c, a, b, d, e) {
    ...
    if (
      ...
      for (var g = 0, m = c.length; g < m; g++) Xa(c[g], a, b, d, e)
  ...
  function wc(c) {
    ...
    return function (a) {
      ...
      this.add(function () {
        m--
        c.unsubscribe()
        h && !r && e && 0 === m && (h.unsubscribe(), (g = h = void 0))
      })
    }
  }
  function da(c, a) {
  ...
  function Cc(c) {
    ...
    g.subscription = d.schedule(lb, a, { subscriber: b, window: f, context: g })
  ...
  var Kb =
        ...
        if (!this.closed) {
          ...
          if (P(d))
            try {
              ...
              a = g instanceof Y ? Ka(g.errors) : [g]
            }
          if (x(e))
            for (f = -1, b = e.length; ++f < b; )
              if (((d = e[f]), ra(d)))
                try {
                  ...
                  ;(a = a || []),
                    g instanceof Y ? (a = a.concat(Ka(g.errors))) : a.push(g)
                }
          if (a) throw new Y(a)
        }
      }
    ...
    pb = (function (c) {
      function a(b, a, e, f) {
        ...
        P(a)
          ...
          : a &&
            ...
            a !== na &&
              ((b = Object.create(a)),
              P(b.unsubscribe) && d.add(b.unsubscribe.bind(b)),
      ...
      a.prototype.next = function (b) {
        if (!this.isStopped && this._next) {
          ...
          C.useDeprecatedSynchronousErrorHandling && a.syncErrorThrowable
      ...
      a.prototype.error = function (b) {
        if (!this.isStopped) {
          ...
          if (this._error)
            ...
            c ? ((a.syncErrorValue = b), (a.syncErrorThrown = !0)) : Q(b),
              this.unsubscribe()
          else {
            this.unsubscribe()
            if (c) throw b
    ...
    U = ("function" === typeof Symbol && Symbol.observable) || "@@observable",
    n = (function () {
      function c(a) {
        this._isScalar = !1
        a && (this._subscribe = a)
  ...
  var w = (function () {
    ...
    W = (function (c) {
      ...
      a.prototype._subscribe = function (b) {
        ...
        this.isStopped || this.hasError
          ? (m = p.EMPTY)
          : (this.observers.push(b), (m = new qb(this, b)))
    ...
    Wc = (function (c) {
      ...
      a.prototype.recycleAsyncId = function (b, a, e) {
        ...
        0 === b.actions.length && (wb.clearImmediate(a), (b.scheduled = void 0))
      }
      return a
    })(ea),
    pa = new ((function (c) {
  ...
  var ad = function (c) {
      ...
      a.prototype.notifyNext = function (b, a, c, f, g) {
        if (!this.hasFirst) {
          ...
          for (b = 0; b < this.subscriptions.length; b++)
            b !== c &&
              ((f = this.subscriptions[b]), f.unsubscribe(), this.remove(f))
    ...
    kd = (function (c) {
      ...
      a.prototype.clearThrottle = function () {
        ...
        a &&
          ((this.value = null), (this.hasValue = !1), this.destination.next(b))
      }
      ...
      a.prototype._next = function (b) {
        for (var a = this.contexts, c = a.length, f, g = 0; g < c; g++) {
          var m = a[g],
            h = m.buffer
          h.push(b)
          h.length == this.maxBufferSize && (f = m)
        }
    ...
    xd = (function (c) {
      ...
      a.prototype.error = function (b) {
        if (!this.isStopped) {
          ...
          b = new H(this, void 0, void 0)
          this.add(b)
          a = q(this, a, void 0, void 0, b)
          a !== b && this.add(a)
        }
      }
      return a
    ...
    Ud = (function () {
      ...
      c.prototype.call = function (a, b) {
        return b.subscribe(new Td(a, this.predicate, this.thisArg, this.source))
      }
      return c
    })(),
    Td = (function (c) {
    ...
    Vd = (function (c) {
      ...
      a.prototype._next = function (b) {
        this.hasSubscription ||
          ((this.hasSubscription = !0), this.add(q(this, b)))
      }
      a.prototype._complete = function () {
        this.hasCompleted = !0
    ...
    Yd = (function (c) {
      ...
      a.prototype.subscribeToProjection = function (b, a, c) {
        this.active++
        this.destination.add(q(this, b, a, c))
      }
      a.prototype._complete = function () {
    ...
    qc = (function () {
      ...
      c.prototype.call = function (a, b) {
        return b.subscribe(new le(a, this.accumulator, this.seed, this.hasSeed))
      }
      return c
    })(),
    le = (function (c) {
    ...
    oe = (function (c) {
      ...
      a.prototype.subscribeToNextSource = function () {
        ...
        if (b) {
          var a = new H(this, void 0, void 0),
            c = this.destination
          c.add(a)
          b = q(this, b, void 0, void 0, a)
          b !== a && c.add(b)
    ...
    te = (function (c) {
      ...
      a.prototype.subscribeToRetries = function () {
        ...
        this.retries = b
        this.retriesSubscription = q(this, b)
      }
      return a
    })(t),
    we = (function () {
        ...
        if (!this.isStopped) {
          ...
          if (e) this.retriesSubscription = this.errors = null
            ...
            try {
              ...
              return c.prototype.error.call(this, m)
            }
            f = q(this, e)
          }
          this._unsubscribeAndRecycle()
    ...
    Me = (function (c) {
      function a(a, d) {
        ...
        a.hasValue = !1
        var b = new H(a, void 0, void 0)
        a.add(b)
        a.innerSubscription = b
        d = q(a, d, void 0, void 0, b)
    ...
    Se = (function (c) {
      ...
      a.prototype._innerSub = function (a, c, e) {
        ...
        e = this.destination
        e.add(c)
        this.innerSubscription = q(this, a, void 0, void 0, c)
      ...
      function a(a, d, e, f) {
        ...
        P(d)
          ...
          : d &&
            ((a._context = d),
            (a._tapNext = d.next || D),
            (a._tapError = d.error || D),
            (a._tapComplete = d.complete || D))
        return a
      }
      h(a, c)
      a.prototype._next = function (a) {
    ...
    Ze = (function (c) {
      ...
      a.prototype.throttle = function (a) {
        ;(a = this.tryDurationSelector(a)) &&
          this.add((this._throttled = q(this, a)))
      }
    ...
    nf = (function (c) {
      function a(a, d, e) {
        ...
        a.closingSelector = e
        a.contexts = []
        a.add((a.openSubscription = q(a, d, d)))
        return a
      }
      h(a, c)
      a.prototype._next = function (a) {
    ...
    pf = (function (c) {
      ...
      a.prototype.openWindow = function (a) {
        ...
        this.add((this.closingNotification = q(this, b)))
      }
      return a
    })(t),
    sf = (function () {
          ...
          function () {
            k = b.subscribe(
              function (a) {
                ...
                f.push({ frame: d.frame, notification: w.createNext(b) })
              },
              function (a) {
      ...
      a.parseMarbles = function (a, c, e, f, g) {
        ...
        for (
          var d = a.length,
            ...
            l = -1 === k ? 0 : k * -this.frameTimeFactor,
            n =
              "object" !== typeof c
                ? function (a) {
                    return a
            ...
            k = function (c) {
              ...
              m && h.push({ frame: -1 < p ? p : l, notification: m })
              l = d
              t = c
            },
            q = this,
    ...
    zf = (function (c) {
      function a(a, d) {
        ...
        a.getHeader(b, "Content-Type") ||
          (z.FormData && d.body instanceof z.FormData) ||
      ...
      a.prototype.serializeBody = function (a, c) {
        if (
          !a ||
          "string" === typeof a ||
          (z.FormData && a instanceof z.FormData)
        )
          return a
        if (c) {
          var b = c.indexOf(";")
          ...
          if (a) {
            if (a.signal)
              if (a.signal.aborted) d.abort()
                ...
                h.add(function () {
                  return l.removeEventListener("abort", n)
                })
              }
            k = ob({}, a, { signal: e })
          } else k = { signal: e }
  ...
  k.forkJoin = function () {
    ...
    if (1 === c.length) {
      ...
      if (ra(b) && Object.getPrototypeOf(b) === Object.prototype)
        return (
          (c = Object.keys(b)),
          ia(
            c.map(function (a) {
  ...
  k.partition = function (c, a, b) {
    return [I(a, b)(new n(ha(c))), I($a(a, b))(new n(ha(c)))]
  }
  k.race = ab
